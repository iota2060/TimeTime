...
public class getTalent_Sale_posting_detail extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            String link = "http://121.191.186.78:8080/get_talent_buy_posting_by_boardNumber.php/";
