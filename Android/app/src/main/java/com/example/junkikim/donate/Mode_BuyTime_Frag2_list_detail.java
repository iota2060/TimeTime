    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.delete_talentSalePosting:
                ...
                String link = "http://121.191.186.78:8080/delete_talent_sale_posting.php/";
            ...
            case R.id.post_review_buy:
                ...
                alertDialog.setPositiveButton("전송하기", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            String link="http://121.191.186.78:8080/insert_review_sale.php/";
        ...
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                try {
                    ...
                    String link = "http://121.191.186.78:8080/get_sale_review_posting.php/";
