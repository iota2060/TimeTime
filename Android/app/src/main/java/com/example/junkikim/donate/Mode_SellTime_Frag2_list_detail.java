 ...
 */
public class Mode_SellTime_Frag2_list_detail extends Fragment{
    ...
    ImageView imView;
    String imgUrl = "http://121.191.186.78:8080/";
    Bitmap bmImg;
    back task;
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if(LoginActivity.id.equals(boardHash.get("id"))){
            ...
            menu.findItem(R.id.delect_board).setVisible(true);
        }
        else {
            menu.findItem(R.id.message).setVisible(true);
            menu.findItem(R.id.post_review_sale).setVisible(true);
        }
    }
        ...
        switch (item.getItemId()){
            case R.id.message:
                ...
                alertDialog.setPositiveButton("전송하기", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        loading = ProgressDialog.show(getActivity(), "Please Wait", "메시지를 전송중입니다.", true, true);
                        FragmentManager fm = getFragmentManager();
                        Fragment fragment = fm.findFragmentById(R.id.maincontainer1);
                        FragmentTransaction tr = fm.beginTransaction();
                        int layout=R.id.maincontainer1;
            ...
            case R.id.modify:
                if(((ViewGroup) getView().getParent()).getId()==R.id.maincontainer1) {
                    Mode_SellTime_Frag2_list_detail_modify modeSellTimeFrag2_list_detail_modify =new Mode_SellTime_Frag2_list_detail_modify(boardHash,bmImg);
                    FragmentManager fm =getFragmentManager();
                    Fragment fragment = fm.findFragmentById(R.id.maincontainer1);
                    FragmentTransaction tr;
                    tr=fm.beginTransaction();
                    tr.remove(fragment);
                    tr.replace(R.id.maincontainer1, modeSellTimeFrag2_list_detail_modify,"modeSellTimeFrag2_list_detail_modify");
                    tr.commit();
                }
                else {
                    Mode_SellTime_Frag2_list_detail_modify modeSellTimeFrag2_list_detail_modify =new Mode_SellTime_Frag2_list_detail_modify(boardHash,bmImg);
                    ...
                    tr=fm.beginTransaction();
                    tr.remove(fragment);
                    tr.replace(R.id.maincontainer2, modeSellTimeFrag2_list_detail_modify,"modeSellTimeFrag2_list_detail_modify");
                    tr.commit();
                }

                break;
            case R.id.delect_board:
                String link = "http://121.191.186.78:8080/delete_talent_buy_posting.php/";
                ...
                //deleteTalentBuyPosting(boardHash.get("boardNumber"));
                break;
            case R.id.post_review_sale:
                alertDialog = new AlertDialog.Builder(getActivity());
                ...
                alertDialog.setPositiveButton("전송하기", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Mode_SellTime_Frag2_list_detail mode_sellTime_frag2_list_detail = new Mode_SellTime_Frag2_list_detail(boardHash);
                        FragmentManager fm =getFragmentManager();
                        Fragment fragment = fm.findFragmentById(R.id.maincontainer1);
                        FragmentTransaction tr;
                        tr=fm.beginTransaction();
                        tr.remove(fragment);
                        tr.replace(R.id.maincontainer1, mode_sellTime_frag2_list_detail,"mode_sellTime_frag2_list_detail");
                        tr.commit();
    ...
    public Mode_SellTime_Frag2_list_detail(HashMap<String, String> boardHash) {
        ...
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                try {
                    ...
                    String link ="http://121.191.186.78:8080/get_review_buy.php/";
    ...
    private void postReview(String id, String writeDate, String score, String contents,String boardNumber) {

        class InsertReview extends AsyncTask<String, Void, String> {
            ProgressDialog loading;
            ...
            protected String doInBackground(String... params) {
                try {
                    ...
                    String link = "http://121.191.186.78:8080/insert_review_buy.php/";
        ...
        InsertReview task = new InsertReview();
        task.execute(id, writeDate,score,contents,boardNumber);
    }
